...
const messagesByLocale: Record<AppLocale, Messages> = {
  "zh-CN": {
    ...
    "composer.instructions": "文本按空行拆分，文件逐条发送，拖拽、粘贴、选择都可以。",
  ...
  en: {
    ...
    "composer.instructions": "Text is split by blank lines and files are sent one by one. Drag, paste, or pick files.",
  ...
  ja: {
    ...
    "composer.instructions": "テキストは空行ごとに分割され、ファイルは 1 件ずつ送信されます。ドラッグ、貼り付け、選択に対応しています。",
  ...
  fr: {
    ...
    "composer.instructions": "Le texte est decoupe par lignes vides et les fichiers sont envoyes un par un. Glissez, collez ou choisissez des fichiers.",
  ...
  de: {
    ...
    "composer.instructions": "Text wird an Leerzeilen getrennt, Dateien werden einzeln gesendet. Ziehen, einfuegen oder auswaehlen ist moeglich.",
  ...
  es: {
    ...
    "composer.instructions": "El texto se divide por lineas en blanco y los archivos se envian uno por uno. Puedes arrastrar, pegar o elegir archivos.",
